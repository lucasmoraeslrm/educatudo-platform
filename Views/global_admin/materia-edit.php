...
<head>
    ...
    <title><?php echo $title ?? 'Editar Matéria - Educatudo'; ?></title>
        ...
        <main>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Editar Matéria</li>
                </ol>
            </nav>
            ...
            <?php if (isset($errors) && !empty($errors)): ?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <h5 class="alert-heading"><i class="bi bi-exclamation-triangle"></i> Erro ao atualizar matéria</h5>
                    <ul class="mb-0">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo $app->url('/admin/escolas/' . $escola['id'] . '/materias/' . $materia['id']); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control <?php echo isset($errors['nome']) ? 'is-invalid' : ''; ?>" 
                                       ...
                                       value="<?php echo htmlspecialchars($_POST['nome'] ?? $materia['nome'] ?? ''); ?>"
                                    ...
                                    <?php if (!empty($professores)): ?>
                                        <?php foreach ($professores as $prof): ?>
                                            <option value="<?php echo $prof['id']; ?>" 
                                                    <?php 
                                                    $selected = isset($_POST['professor_id']) 
                                                        ? ($_POST['professor_id'] == $prof['id']) 
                                                        : ($materia['professor_id'] == $prof['id']);
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-danger" onclick="confirmarExclusao()">
                                <i class="bi bi-trash"></i> Excluir Matéria
                            </button>
                    ...
                    <form id="formExcluir" method="POST" action="<?php echo $app->url('/admin/escolas/' . $escola['id'] . '/materias/' . $materia['id']); ?>" style="display: none;">
